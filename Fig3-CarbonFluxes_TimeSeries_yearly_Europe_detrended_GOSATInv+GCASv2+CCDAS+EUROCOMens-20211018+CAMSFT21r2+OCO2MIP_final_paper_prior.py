...
dir8='/Volumes/HEWEI_T5/OCO-2_v10_MIP/Prior/'      #    IS
...
##    ax5.plot(pydates2[9+5:],-oco2mipneeann_v10mean_LNLGIS,linewidth=mlw*1.0,color='pink',linestyle='-', marker='^', markersize = 5)   
   ...
   # ax5.plot(pydates2[9+5:],-oco2mip9neeann,linewidth=mlw*1.0,color='skyblue',linestyle='-', marker='.', markersize = 1.5)   
    ...
    median = np.nanmedian([-oco2mip1neeann,-oco2mip2neeann,-oco2mip3neeann,-oco2mip4neeann,-oco2mip5neeann,-oco2mip6neeann,-oco2mip7neeann, \
                           -oco2mip8neeann,-oco2mip10neeann,-oco2mip11neeann,-oco2mip13neeann,-oco2mip13neeann,-oco2mip14neeann], axis=0)  

    ax5.plot(pydates2[9+5:],median,linewidth=mlw*1.0,color='r',linestyle='-', marker='^', markersize = 5)   
...
flag=1
data = pipeline(35, 70, -10, 40,flag,'All_Flux_timeseries_Europe_AIMs_20211201_EUROCOM+GOSAT2+GCASv2+CCDAS2_final_prior')
